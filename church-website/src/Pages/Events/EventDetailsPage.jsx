...
function EventDetailsPage() {
  ...
  'fellowship-sunday': {
    'january': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Fellowship Gathering', date: 'Jan 15, 2024', description: 'Congregation during worship.' },
    ...
    'february': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Community Outreach', date: 'Feb 18, 2024', description: 'Volunteers helping out.' },
    ...
    'march': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'March Congregation', date: 'Mar 10, 2024', description: 'Congregation during March service.' },
      ]
    },
    'april': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'April Worship', date: 'Apr 14, 2024', description: 'Joyful worship in April.' },
      ]
    },
    'may': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984534-b2586552e46b?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'May Community', date: 'May 19, 2024', description: 'Community sharing in May.' },
      ]
    },
    'june': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'June Unity', date: 'Jun 9, 2024', description: 'United in faith during June service.' },
      ]
    },
  'july': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'July Guidance', date: 'Jul 14, 2024', description: 'Seeking guidance in July.' },
      ]
    },
    'august': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'August Peace', date: 'Aug 18, 2024', description: 'Peaceful moments in August.' },
      ]
    },
    'september': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'September Learning', date: 'Sep 8, 2024', description: 'Learning and growing in September.' },
      ]
    },
    'october': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'October Harvest', date: 'Oct 13, 2024', description: 'Harvest celebrations in October.' },
      ]
    },
    'november': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'November Gratitude', date: 'Nov 17, 2024', description: 'Thankful hearts in November.' },
      ]
    },
    'december': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984534-b2586552e46b?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'December Anticipation', date: 'Dec 8, 2024', description: 'Joyful anticipation in December.' },
      ]
    },
  },
  'christmas-carol-competition': {
    ...
    'december': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1549420042-302a2455928a?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Carol Choir', date: 'Dec 20, 2024', description: 'The winning choir performance.' },
  ...
  'halleluyah-party': {
    ...
    'october': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1549420042-302a2455928a?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Party Fun', date: 'Oct 31, 2024', description: 'Children enjoying the games.' },
  ...
  'queen-esther': {
    '2013': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Queen Esther 2013 Winner', date: '2013', description: 'The crowned Queen Esther.' },
      ]
    },
    '2014': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Queen Esther 2014 Contestants', date: '2014', description: 'Group photo of contestants.' },
      ]
    },
    '2015': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Queen Esther 2015 Highlights', date: '2015', description: 'Memorable moments from 2015.' },
      ]
    },
    '2016': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Queen Esther 2016 Participants', date: '2016', description: 'Participants showcasing their grace.' },
      ]
    },
    '2017': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984534-b2586552e46b?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Queen Esther 2017 Crowning', date: '2017', description: 'The crowning moment of 2017.' },
      ]
    },
  },
  'grace': {
    '2014': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Grace Conference Opening', date: '2014', description: 'Opening session of the conference.' },
      ]
    },
    '2015': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Grace Conference Speakers', date: '2015', description: 'Keynote speakers sharing insights.' },
      ]
    },
    '2016': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Grace Conference 2016 Session', date: '2016', description: 'Engaging sessions from 2016.' },
      ]
    },
    '2017': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Grace Conference 2017 Worship', date: '2017', description: 'Uplifting worship moments from 2017.' },
      ]
    },
    '2018': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Grace Conference 2018 Attendees', date: '2018', description: 'Attendees at the 2018 conference.' },
      ]
    },
    '2019': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Grace Conference 2019 Closing', date: '2019', description: 'Closing remarks from 2019 conference.' },
      ]
    },
  },
  'baby-dedication': {
    'january': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Jan Dedication Moment', date: 'Jan 2024', description: 'Parents dedicating their child in January.' },
      ]
    },
    'february': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Feb Dedication Moment', date: 'Feb 2024', description: 'Parents dedicating their child in February.' },
      ]
    },
    'march': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Mar Dedication Moment', date: 'Mar 2024', description: 'Parents dedicating their child in March.' },
      ]
    },
    'april': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Apr Dedication Moment', date: 'Apr 2024', description: 'Parents dedicating their child in April.' },
      ]
    },
    'may': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'May Dedication Moment', date: 'May 2024', description: 'Parents dedicating their child in May.' },
      ]
    },
    'june': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Jun Dedication Moment', date: 'Jun 2024', description: 'Parents dedicating their child in June.' },
      ]
    },
    'july': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Jul Dedication Moment', date: 'Jul 2024', description: 'Parents dedicating their child in July.' },
      ]
    },
    'august': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Aug Dedication Moment', date: 'Aug 2024', description: 'Parents dedicating their child in August.' },
      ]
    },
    'september': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Sep Dedication Moment', date: 'Sep 2024', description: 'Parents dedicating their child in September.' },
      ]
    },
    'october': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Oct Dedication Moment', date: 'Oct 2024', description: 'Parents dedicating their child in October.' },
      ]
    },
    'november': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Nov Dedication Moment', date: 'Nov 2024', description: 'Parents dedicating their child in November.' },
      ]
    },
    'december': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1579782522770-5d665790b0d3?q=80&w=1470&auto=format&fit=crop', type: 'image', title: 'Dec Dedication Moment', date: 'Dec 2024', description: 'Parents dedicating their child in December.' },
      ]
    },
  },
  'weddings': {
    'january': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Jan Wedding Bliss', date: 'Jan 2024', description: 'Couples exchanging vows in January.' },
      ]
    },
    'february': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Feb Wedding Bliss', date: 'Feb 2024', description: 'Couples exchanging vows in February.' },
      ]
    },
    'march': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Mar Wedding Bliss', date: 'Mar 2024', description: 'Couples exchanging vows in March.' },
      ]
    },
    'april': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Apr Wedding Bliss', date: 'Apr 2024', description: 'Couples exchanging vows in April.' },
      ]
    },
    'may': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984534-b2586552e46b?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'May Wedding Bliss', date: 'May 2024', description: 'Couples exchanging vows in May.' },
      ]
    },
    'june': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Jun Wedding Bliss', date: 'Jun 2024', description: 'Couples exchanging vows in June.' },
      ]
    },
    'july': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1606553896587-57351658b191?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Jul Wedding Bliss', date: 'Jul 2024', description: 'Couples exchanging vows in July.' },
      ]
    },
    'august': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Aug Wedding Bliss', date: 'Aug 2024', description: 'Couples exchanging vows in August.' },
      ]
    },
    'september': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1522851165-8b3d81b2a95c?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Sep Wedding Bliss', date: 'Sep 2024', description: 'Couples exchanging vows in September.' },
      ]
    },
    'october': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1517409224419-7981b9514781?q=80&w=1471&auto=format&fit=crop', type: 'image', title: 'Oct Wedding Bliss', date: 'Oct 2024', description: 'Couples exchanging vows in October.' },
      ]
    },
    'november': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984443-a60d0061e389?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Nov Wedding Bliss', date: 'Nov 2024', description: 'Couples exchanging vows in November.' },
      ]
    },
    'december': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1628155984534-b2586552e46b?q=80&w=1543&auto=format&fit=crop', type: 'image', title: 'Dec Wedding Bliss', date: 'Dec 2024', description: 'Couples exchanging vows in December.' },
      ]
    },
  },
  'christmas-lights': {
    ...
    'december': {
      ...
      media: [
        { src: 'https://images.unsplash.com/photo-1543322198-d1061907ee93?q=80&w=1632&auto=format&fit=crop', type: 'image', title: 'Festive Lights', date: 'Dec 2024', description: 'The church grounds illuminated for Christmas.' },
    ...
    return (
        <div className="container py-5 mt-5 ">
            <header className="text-center mb-5">
                ...
                <p className="lead text-dark">{eventData.details}</p>
                <hr className="my-4 border-warning w-25 mx-auto" />
            </header>

            {eventData.media && eventData.media.length > 0 ? (
                <section className="media-gallery">
                    <h3 className="text-dark mb-4 text-center">Event Media</h3>
