    ...
    const GalleryData = [
        {
            ...
            description: 'A vibrant gathering of the community.',
        },
        {
            src: '/assets/Images/ca3.png',
            type: 'image',
            title: 'Church Event 2',
            date: 'February 20, 2024',
            description: 'Celebrating milestones and blessings.',
        },
        {
            ...
            date: 'March 10, 2024',
            description: 'Inspiring worship session.',
        },
        {
            src: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', // Example audio URL
            type: 'audio',
            title: 'Sermon Audio',
            date: 'April 5, 2024',
            description: 'Listen to the latest sermon.',
        },
        {
            src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', // Example video URL
            type: 'video',
        ...
        },
        {
            ...
            date: 'June 1, 2024',
            description: 'Annual harvest thanksgiving.',
        },
        {
            src: '/assets/Images/ca1.png',
            type: 'image',
            ...
            date: 'July 8, 2024',
            description: 'Special prayer meeting.',
        },
        {
            src: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', // Another example audio URL
            type: 'audio',
            title: 'Choir Performance',
            date: 'August 1, 2024',
            description: 'Enjoy our choir\'s latest performance.',
        },
        {
            src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', // Another example video URL
            type: 'video',
            title: 'Youth Camp Recap',
            date: 'September 19, 2024',
            description: 'A look back at our amazing youth camp.',
        },
    ];
